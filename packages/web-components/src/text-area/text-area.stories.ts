...
import type { TextArea as FluentTextArea } from './text-area.js';
import { TextAreaResize } from './text-area.options.js';

type TextAreaStoryArgs = Args & FluentTextArea;
...
const storyTemplate = html<TextAreaStoryArgs>`
  <fluent-text-area
...
export const TextArea = renderComponent(storyTemplate).bind({});
